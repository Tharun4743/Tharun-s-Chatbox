    ...
    >
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground/60 max-w-xs mx-auto text-sm font-medium italic">
          "The journey to intelligence starts with a single click."
        </p>
      </div>
      ...
      <div className="text-center space-y-6">
        <p className="text-sm font-medium text-muted-foreground/60">
          New to the family?{' '}
          <Link href="/signup" className="text-foreground font-bold hover:text-primary transition-colors underline underline-offset-4 decoration-border/50">
            Create an account
          </Link>
        </p>
      </div>
